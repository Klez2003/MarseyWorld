...
AWARDS = {
	...
	"owoify": {
		"kind": "owoify",
		"title": "OwOify",
		"description": "Turns the recipient into a furry for 24 hours.",
	...
	"rehab": {
		"kind": "rehab",
		"title": "Rehab",
		"description": "Prevents the recipient from gambling for 24 hours in a last-ditch effort to save them from themself.",
	...
	"pinghab": {
		"kind": "pinghab",
		"title": "Pinghab",
		"description": "Prevents the recipient from pinging for 24 hours in a last-ditch effort to save others from their attention-seeking.",
		"icon": "fas fa-face-shush",
		"color": "text-yellow",
		"price": 777,
		"cosmetic": False,
		"ghost": False,
	...
	"deflector": {
		"kind": "deflector",
		"title": "Deflector",
		"description": "Causes negative awards received for the next 12 hours to be deflected back at their giver.",
		"icon": "fas fa-shield",
		"color": "text-pink",
		"price": 2500,
		"cosmetic": False,
