...
if SITE_NAME == 'rDrama':
	...
	PERMS = { # Minimum admin_level to perform action.
		...
		'VIEW_RESTRICTED_HOLES': 2,
		'BYPASS_UNDER_SIEGE_MODE': 2,
		'NOTIFICATIONS_SPECIFIC_WPD_COMMENTS': 2,
		'MESSAGE_BLOCKED_USERS': 2,
		'USER_BAN': 2,
		'USER_SHADOWBAN': 2,
		'USER_CHUD': 2,
		...
		'ORGIES': 2,
		'DELETE_MEDIA': 2,
		'ADMIN_ACTIONS_REVERT': 2,
		'DOMAINS_BAN': 2,
		'EDIT_RULES': 2,
		'SITE_SETTINGS': 2,
		'SITE_CACHE_PURGE_CDN': 2,
		'NOTIFICATIONS_FROM_SHADOWBANNED_USERS': 2,
		'USE_ADMIGGER_THREADS': 2,
		'MODERATE_PENDING_SUBMITTED_ASSETS': 2,
		'UPDATE_ASSETS': 2,
		'MARK_EFFORTPOST': 2,
		'CSS_DISABLED': 2,
		'HOLE_CREATE': 2,
		...
		'USER_BLACKLIST': 2,
		'VIEW_PATRONS': 2,
		'BLACKJACK_NOTIFICATIONS': 2,
		'IGNORE_BADGE_BLACKLIST': 2,
		'ENABLE_DM_MEDIA': 2,
		'SEE_GHOST_VOTES': 2,
		'SITE_OFFLINE_MODE': 2,
		'IGNORE_DOMAIN_BAN': 2,
		'USER_RESET_PASSWORD': 2,
		'CLAIM_REWARDS_ALL_USERS': 2,
		'IGNORE_AWARD_IMMUNITY': 2,
		'INSERT_TRANSACTION': 2,
		'APPS_MODERATION': 2,
		'CHANGE_UNDER_SIEGE': 2,
		'VIEW_IPS': 2,
		'VIEW_EMAILS': 2,
		'VIEW_CHATS': 2,
		'USER_LINK': 2,
...
if SITE in {'rdrama.net', 'staging.rdrama.net'}:
	...
	GET_HELP_MESSAGE = "Hi there,\n\nA [concerned user](/id/{vid}) reached out to us about you.\n\nWhen you're in the middle of something painful, it may feel like you don't have a lot of options. But whatever you're going through, you deserve help and there are people who are here for you.\n\nThere are resources available in your area that are free, confidential, and available 24/7:\n\n- Call, Text, or Chat with Canada's [Crisis Services Canada](https://www.crisisservicescanada.ca/en/)\n\n- Call, Email, or Visit the UK's [Samaritans](https://www.samaritans.org/)\n\n- Text CHAT to America's [Crisis Text Line](https://www.crisistextline.org/) at 741741.\n\nIf you don't see a resource in your area above, here is [a comprehensive list of resources and hotlines for people organized by location](/h/suicide/post/196839/). Find Someone Now.\n\nIf you think you may be depressed or struggling in another way, don't ignore it or brush it aside. Take yourself and your feelings seriously, and reach out to someone.\n\nIt may not feel like it, but you have options. There are people available to listen to you, and ways to move forward.\n\nYour fellow users care about you and there are people who want to help."
