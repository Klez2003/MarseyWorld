...
GIRL_NAMES = {
	...
	'G': ['Grace', 'Gabrielle', 'Gabriella', 'Gabriela', 'Giselle', 'Gianna', 'Gracie', 'Guadalupe', 'Genesis', 'Gillian', 'Georgia', 'Gina', 'Gloria', 'Gisselle', 'Genevieve', 'Gwendolyn', 'Gretchen', 'Greta', 'Giovanna', 'Graciela', 'Gia'],
