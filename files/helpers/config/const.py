...
if SITE_NAME == 'rDrama':
	...
	RDRAMA_SLURS = {
		...
		"explain": "mansplain",
		"autisim": "darkly devine feminine creative force"
	}
...
COINTOSS_REPLIES = ('<b style="color:#6023f8">Result: HEADS</b>','<b style="color:#d302a7">Result: TAILS</b>','<b style="color:#e7890c">Result: :marseysoypoint: Edge :!marseysoypoint:</b>')
