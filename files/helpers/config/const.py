...
PERMS = { # Minimum admin_level to perform action.
	...
	'BYPASS_SITE_READ_ONLY_MODE': 3,
	'BYPASS_UNDER_SIEGE_MODE': 3,
	'BYPASS_CHAT_TRUESCORE_REQUIREMENT': 3,
	'WARN_ON_FAILED_LOGIN': 3,
...
if SITE in {'rdrama.net', 'staging.rdrama.net'}:
	...
	EXEMPT_FROM_SPAM_FILTER = BOT_SYMBOL_HIDDEN | {1703, 13427, 15014, 24197, 25816}
