...
COINFLIP_HEADS_OR_TAILS = ('<b style="color:#6023f8">Coinflip: :coinflip_heads:</b>','<b style="color:#d302a7">Coinflip: :coinflip_tails:</b>')
COINFLIP_EDGE = '<b style="color:#e7890c">Coinflip: :!marseysoypoint: :coinflip_edge: :marseysoypoint:</b>'
