...
if SITE in {'rdrama.net', 'staging.rdrama.net'}:
	...
	ADMIGGER_THREADS = {SIDEBAR_THREAD, BANNER_THREAD, BADGE_THREAD, SNAPPY_THREAD, CHANGELOG_THREAD, 22937, 106665}
