...
MODACTION_TYPES_FILTERED = deepcopy({t:v for t,v in MODACTION_TYPES.items() if not t in MODACTION_PRIVILEGED_TYPES})
MODACTION_TYPES_FILTERED.pop("shadowban")
MODACTION_TYPES_FILTERED.pop("unshadowban")
