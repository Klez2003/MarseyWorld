...
word_regex = re.compile("[a-z]+", flags=re.I|re.A)
...
tlds = ( # Original gTLDs and ccTLDs
	...
	'lr','ls','lt','lu','lv','ly','ma','mc','me','mg','mh','mil','mk','ml','mm','mn','mo',
	'mobi','mp','mq','mr','ms','mt','mu','museum','mv','mw','mx','my','mz','na','name',
	'nc','ne','net','nf','ng','ni','nl','no','np','nr','nu','nz','om','org','pa','pe','pf','pg',
	'ph','pk','pl','pm','pn','post','pr','pro','ps','pt','pw','qa','re','ro','ru','rw',
	'sa','sb','sc','sd','se','sg','si','sj','sk','sl','sm','sn','so','social','sr','ss','st',
	...
	'red','city','quest','works','soy','zone','gl','fyi',
	)
