...
def post_embed(id, v):
	...
	if p: return render_template("post_listing.html", listing=[p], v=v, crosspost=True)
	return ''
...
def template_asset_siteimg(asset_path):
	return f'{SITE_FULL_IMAGES}/i/{SITE_NAME}/{asset_path}?x=15'
...
def inject_constants():
	return {
			...
			"AEVANN_ID":AEVANN_ID, "session":session,
		}
